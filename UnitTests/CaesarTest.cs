...
namespace Tests.TemplateAndPluginTests
{
    ...
    public class CaesarTest
    {
        ...
        TestVector[] testvectors = new TestVector[] {
            new TestVector () { n=0, key=24, alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ", input="Franz jagt im komplett verwahrlosten Taxi quer durch Bayern", output="Dpylx hyer gk imknjcrr tcpuyfpjmqrcl Ryvg oscp bspaf Zywcpl", sensitivity=false },
