...
namespace Tests.TemplateAndPluginTests
{
    ...
    public class RC2Test
    {
        ...
        public void RC2TestMethod()
        {
            ...
            var scenario = new PluginTestScenario(pluginInstance, new[] { "InputStream", "InputIV", "InputKey", ".Action" }, new[] { "OutputStream" });

            foreach (TestVector vector in testvectors)
            {
                object[] output = scenario.GetOutputs(new object[] { vector.input.HexToStream(), vector.IV.HexToByteArray(), vector.key.HexToByteArray(), vector.mode });
        ...
        TestVector[] testvectors = new TestVector[] {
            ...
            new TestVector () { n=3, mode=0, key="88", IV="0000000000000000", input="0000000000000000", output="61a8a244adacccf0" }, 
