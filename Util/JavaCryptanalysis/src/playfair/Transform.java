...
public class Transform {
    ...
    private static final int TOTAL_NUMBER_OF_PERMUTATIONS = T_PERM_COLS_OF_1_ROW_END;

    private static final int[] REMAPPING = initialMap();
    ...
    static void randomize() {
        for (int i = 0; i < TOTAL_NUMBER_OF_PERMUTATIONS - 1; i++) {
            int j = i + Utils.random.nextInt(TOTAL_NUMBER_OF_PERMUTATIONS - i);
    ...
    static void applyTransformation(Key parent, Key child, long serialFull) {
