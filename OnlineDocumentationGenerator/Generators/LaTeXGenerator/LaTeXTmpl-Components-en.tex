...
The first part of this document (``Overview over the Components'') compactly lists all templates. For each template, it lists the icon, the title and a short summary. The templates are presented in the same order as they appear in the Startcenter of CT2.\\\\
