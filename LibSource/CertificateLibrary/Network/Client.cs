...
namespace CertificateLibrary.Network
{
    public class CertificateClient
    {
        ...
        public CertificateClient()
            : this(Properties.Settings.Default.PCP_SERVER_ADDRESS,
                Properties.Settings.Default.PCP_SERVER_PORT,
                Properties.Settings.Default.CONNECTION_TIMEOUT,
                NetworkProtocol.PCP)
        {
        }
                      ...
                      int timeout, NetworkProtocol protocol)
        {
            ...
            this.serverTlsCertificate = new System.Security.Cryptography.X509Certificates.X509Certificate(Properties.Resources.paporator_ssl);
            this.UseProxy = false;
