...
namespace EnigmaAnalyzer.Common
{
            ...
            using (countdownEvent = new CountdownEvent(runnables.Count))
            {
                ...
                foreach (var runnable in runnables)
                {
                    ...
                    {                       
                        ...
                        {
                            Console.WriteLine(string.Format("Exception occured during execution of thread: {0}", ex.Message));
                ...
                //Console.WriteLine("Elapsed {0} for {1} tasks on {2} threads", DateTime.Now - start, runnables.Count, threads);                      
            }
        }
    }
}