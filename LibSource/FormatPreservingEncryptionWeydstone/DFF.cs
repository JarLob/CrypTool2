...
//	     */
//        public DFF(int radix, int tweakRadix, Offset off)
//        {
//            // validate radix
...
//            {
//                Console.WriteLine("FF2.Decrypt()\n");
//                Console.WriteLine("X is " + Common.intArrayToString(X));
//                Console.WriteLine("Tweak is " + (T.Length > 0 ? Common.intArrayToString(X) : "empty") + "\n");
//            }
...
//            if (Constants.CONFORMANCE_OUTPUT)
//            {
//                Console.WriteLine("FF2.Encrypt()\n");
//                Console.WriteLine("X is " + Common.intArrayToString(X));
//                Console.WriteLine("Tweak is " + (Tweak.Length > 0 ? Common.intArrayToString(T) : "empty") + "\n");
//            }
