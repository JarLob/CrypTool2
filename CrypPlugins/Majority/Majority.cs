...
namespace Cryptool.Majority
{
    ...
    [PluginInfo(true, "Majority", "Simple Binary XOR", "Majority/DetailedDescription/Description.xaml", "Majority/Images/icon.png", "Majority/Images/icon.png", "Majority/Images/icon.png")]
