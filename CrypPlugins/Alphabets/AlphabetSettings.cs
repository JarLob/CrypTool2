...
namespace Cryptool.Alphabets
{
    public class AlphabetSettings : ISettings
    {
        ...
        //[TaskPane("UpperLowerCaseLettersCaption", "UpperLowerCaseLettersTooltip", null, 2, false, ControlType., new string[] { "UpperLowerCaseLettersList1", "UpperLowerCaseLettersList2", "UpperLowerCaseLettersList3" })]
