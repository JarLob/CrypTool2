...
namespace Cryptool.Alphabets
{
  [Author("Sebastian Przybylski", "sebastian@przybylski.org", "Uni-Siegen", "http://www.uni-siegen.de")]
    ...
    public class Alphabet : IInput
    {
      ...
      [PropertyInfo(Direction.Output, "Alphabet Output", "Alphabet output to use as alphabet input for classical ciphers", "", false, false, DisplayLevel.Beginner, QuickWatchFormat.Text, null)]
