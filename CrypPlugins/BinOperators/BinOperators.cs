...
namespace Cryptool.Plugins.BinOperators
{
    ...
    [PluginInfo(false, "BinOperator", "Simple binary operations (is, is not, smaller, bigger)", "", "BinOperators/icons/icon1.png", "BinOperators/icons/icon2.png", "BinOperators/icons/icon3.png", "BinOperators/icons/icon4.png")]
    
    class BinOperators : IThroughput
    {
        #region private variables

        private BinOperatorsSettings settings = new BinOperatorsSettings();
        ...
        public BinOperators()
        {
            this.settings = new BinOperatorsSettings();
        ...
        public ISettings Settings
        {
            ...
            set { this.settings = (BinOperatorsSettings)value; }
        }

        private void BinOperators_LogMessage(string msg, NotificationLevel loglevel)
        {
                    ...
                    case 2:
                        {
                            ...
                            BinOperators_LogMessage("The chosen operator is not defined for the current inputs. Output is set to false automatically.", NotificationLevel.Warning);
                            Output = false;
