...
namespace Cryptool.Plugins.Convertor
{
    public class StringToStreamConverterSettings : ISettings
    {
        ...
        /// </summary>
        [ContextMenu("Output stream encoding", "Choose the encoding of the output stream. (Byte encoding)", 1, DisplayLevel.Experienced, ContextMenuControlType.ComboBox, null, new string[] { "Default", "Binary data (convert from base64)", "Binary data (convert from hex-string)", "Binary data (convert from octal-string)", "Unicode", "UTF-7", "UTF-8", "UTF-32", "ASCII", "Big endian unicode" })]
        [TaskPane("Output stream encoding", "Choose the encoding of the output stream. (Byte encoding)", "", 1, false, DisplayLevel.Experienced, ControlType.ComboBox, new string[] { "Default", "Binary data (convert from base64)", "Binary data (convert from hex-string)", "Binary data (convert from octal-string)", "Unicode", "UTF-7", "UTF-8", "UTF-32", "ASCII", "Big endian unicode" })]
