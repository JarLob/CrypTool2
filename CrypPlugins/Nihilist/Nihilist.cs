...
namespace Nihilist
{
    ...
    public class Nihilist : IEncryption
    {
        ...
        [PropertyInfo(Direction.OutputData, "Output byte array", "This is the byte array processed by Nihilist cipher, now as byte array.", "", true, false, DisplayLevel.Beginner, QuickWatchFormat.Text, null)]
        public byte[] Output
        {
            get { return output; }
            set
