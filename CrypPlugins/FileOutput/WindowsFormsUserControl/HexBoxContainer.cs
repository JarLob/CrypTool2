  ...
  public partial class HexBoxContainer : UserControl
  {
    ...
    public DialogResult CloseFile()
    {
      ...
      try
      {
        ...
        //else if (hexBox.ByteProvider != null && hexBox.ByteProvider.HasChanges() && _fileName == newFileName)
        //{
        //  bool saveFile = MessageBoxHelper.Question("Do you want to save file?");
        ...
        //  CleanUp();
        //  if (!saveFile && File.Exists(newFileName)) File.Delete(newFileName);
      ...
      {
        UpdateFileSizeStatus();
        if (OnFileClosed != null) OnFileClosed(this);
      }
    }
