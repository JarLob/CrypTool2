...
namespace FileOutput
{
  ...
  public class FileOutputClass : IOutput
  {
    ...
    [PropertyInfo(Direction.Input, "Stream Input", "Display the input file in HexEditor.", "", true, false, DisplayLevel.Beginner, QuickWatchFormat.Hex, null)]
    public CryptoolStream StreamInput
    {
      ...
      set
      {
        if (settings.TargetFilename == null) Progress(0.5, 1.0);
        if (value != null)
        {
    ...
    public void Dispose()
    {
      ...
      fileOutputPresentation.ClosePresentationFile();
      settings.SaveAndRestoreState = InputFile;
    }
