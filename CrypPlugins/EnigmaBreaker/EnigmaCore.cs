...
namespace Cryptool.EnigmaBreaker
{
    ...
    internal partial class EnigmaCore
    {
        ...
        private EnigmaBreaker pluginFacade;
        private EnigmaBreakerSettings settings;
        ...
        { 
            get {return currentRotorPositionsString();} 
        }
        ...
        public EnigmaCore(EnigmaBreaker facade)
        {
            pluginFacade = facade;
            settings = (EnigmaBreakerSettings)pluginFacade.Settings;
            iCfg = new internalConfigStruct();
        }


        /// <summary>
        /// Encrypts or decrypts a string with the given rotor positions
        ...
        public string Encrypt(int rotor1Pos, int rotor2Pos, int rotor3Pos, int rotor4Pos, string input)
        {
            ...
            // set the current rotor positions
        ...
        private char enigmaSpindle(char entrySubst)
        {
            ...
            //    settings.InitialRotorPos = currentRotorPositionsString();
        ...
        /// <summary>
        /// Returns the current rotor positions as a string, i.e. the rotor positions in the settings pane
        /// </summary>
        private string currentRotorPositionsString()
        {
            ...
            string rotorPos = R3.ToString() + R2.ToString() + R1.ToString();
