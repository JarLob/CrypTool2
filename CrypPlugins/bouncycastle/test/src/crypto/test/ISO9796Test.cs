...
namespace Org.BouncyCastle.Crypto.Tests
{
	...
	[TestFixture]
	public class ISO9796Test : ITest
	{
		...
		private ITestResult DoTest1()
		{
			...
			{
				return new SimpleTestResult(false, "ISO9796: failed - exception " + e.Message);
			}
		...
		public virtual ITestResult DoTest3()
		{
		...
		public virtual ITestResult DoTest4()
		{
		...
		public virtual ITestResult DoTest5()
		{
			RsaKeyParameters pubParameters = new RsaKeyParameters(false, mod3, pub3);
			RsaKeyParameters privParameters = new RsaKeyParameters(true, mod3, pri3);
			RsaEngine rsa = new RsaEngine();
		...
		//
		public virtual ITestResult DoTest6()
		{
		...
		public virtual ITestResult DoTest7()
		{
		...
		public virtual ITestResult DoTest8()
		{
		...
		public virtual ITestResult DoTest9()
		{
			RsaKeyParameters pubParameters = new RsaKeyParameters(false, mod6, pub6);
			RsaKeyParameters privParameters = new RsaKeyParameters(true, mod6, pri6);
			RsaEngine rsa = new RsaEngine();
