...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: SimpleTest
	{
		...
		public void TestDH()
		{
			...
			DHParameters pr2 = new DHParameters(pr1.P, pr1.G, pr1.Q, pr1.J, pr1.ValidationParameters);
			DHParameters pr3 = new DHParameters(pr1.P.Add(BigInteger.Two), pr1.G, pr1.Q, pr1.J, pr1.ValidationParameters);

			doTest(pr1, pr2, pr3);

			pr3 = new DHParameters(pr1.P, pr1.G.Add(BigInteger.One), pr1.Q, pr1.J, pr1.ValidationParameters);
