...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: SimpleTest
    {
		...
		public override void PerformTest()
        {
			...
			if (!r.Equals(sig[0]))
            {
                Fail("r component wrong." + System.Environment.NewLine
					+ " expecting: " + r + System.Environment.NewLine
					+ " got      : " + sig[0]);
            }

            if (!s.Equals(sig[1]))
            {
                Fail("s component wrong." + System.Environment.NewLine
					+ " expecting: " + s + System.Environment.NewLine
					+ " got      : " + sig[1]);
            }
