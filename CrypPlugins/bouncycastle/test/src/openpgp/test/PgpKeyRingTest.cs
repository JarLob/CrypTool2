...
//		private static readonly byte[] subKeyBindingCheckSum = Base64.Decode("3HU+");
		...
		public void PerformTest1()
		{
			...
			//
			count = 0;
			foreach (object o1 in secretRings.GetKeyRings("test (Test key) <test@ubicall.com>"))
			{
				if (o1 == null)
					Fail("null keyring found");
			...
			//
			count = 0;
			foreach (object o2 in secretRings.GetKeyRings("test", true))
			{
				if (o2 == null)
					Fail("null keyring found");
			...
			//
			count = 0;
			foreach (object o3 in secretRings.GetKeyRings("test", false))
			{
				if (o3 == null)
					Fail("null keyring found");
		...
		public void PerformTest5()
		{
			...
			foreach (PgpPublicKeyRing pgpPub1 in pubRings.GetKeyRings())
			{
				...
				foreach (object o in pgpPub2.GetPublicKeys())
				{
					if (o == null)
						Fail("null keyring found");
		...
		private void PublicKeyRingWithX509Test()
		{
