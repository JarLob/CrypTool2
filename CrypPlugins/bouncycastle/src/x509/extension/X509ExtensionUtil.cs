...
namespace Org.BouncyCastle.X509.Extension
{
	public class X509ExtensionUtilities
	{
		...
		private static ICollection GetIssuerAlternativeNames(
		...
		private static ICollection getSubjectAlternativeNames(X509Certificate cert)
		{        
			...
			Asn1OctetString extVal)
		{
			...
			if (extVal != null)
			{
				try
				{
					Asn1Sequence seq = DerSequence.GetInstance(
						Asn1Object.FromByteArray(extVal.GetOctets()));
