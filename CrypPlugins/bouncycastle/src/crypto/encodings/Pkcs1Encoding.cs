...
namespace Org.BouncyCastle.Crypto.Encodings
{
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		...
		{
			get { return strictLengthEnabled; }
			set { strictLengthEnabled = value; }
		}

		private static bool strictLengthEnabled;

		static Pkcs1Encoding()
		{
			string strictProperty = Platform.GetEnvironmentVariable(StrictLengthEnabledProperty);

			strictLengthEnabled = strictProperty == null || strictProperty.Equals("true");
		}
