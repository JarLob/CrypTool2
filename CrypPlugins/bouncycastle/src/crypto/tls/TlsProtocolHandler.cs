...
namespace Org.BouncyCastle.Crypto.Tls
{
	...
	public class TlsProtocolHandler
	{
		...
		*/
		...
		private const short CS_SERVER_HELLO_DONE_RECEIVED = 5;
		private const short CS_CLIENT_KEY_EXCHANGE_SEND = 6;
		private const short CS_CLIENT_CHANGE_CIPHER_SPEC_SEND = 7;
		private const short CS_CLIENT_FINISHED_SEND = 8;
		private const short CS_SERVER_CHANGE_CIPHER_SPEC_RECEIVED = 9;
		private const short CS_DONE = 10;
