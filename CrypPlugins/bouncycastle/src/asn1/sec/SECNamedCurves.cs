...
namespace Org.BouncyCastle.Asn1.Sec
{
	public sealed class SecNamedCurves
	{
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp112r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp112r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp128r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp128r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp160k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp160r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp160r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp192k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp192r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp224k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp224r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp256k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp256r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp384r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Secp521r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect113r1Holder();
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECCurve curve = new F2mCurve(m, k, a, b);
				//ECPoint G = curve.DecodePoint(Hex.Decode("03"
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect113r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect131r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect131r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect163k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect163r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect163r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect193r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect193r2Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect233k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect233r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect239k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect283k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect283r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect409k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect409r1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect571k1Holder();
			...
			: X9ECParametersHolder
		{
			...
			internal static X9ECParametersHolder Instance = new Sect571r1Holder();
