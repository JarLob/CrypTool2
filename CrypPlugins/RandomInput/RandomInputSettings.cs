...
namespace RandomInput
{
  public class RandomInputSettings : ISettings
  {
    ...
    [TaskPane("Counter", "Number of random bytes to be created. (1 - 10496000)", null, 1, false, DisplayLevel.Beginner, ControlType.NumericUpDown, ValidationType.RangeInteger, 1, 10496000)]
    public int Bytes
    {
    ...
    [ContextMenu("Static", "Generate and keep random bytes only once", 2, DisplayLevel.Beginner, ContextMenuControlType.ComboBox, null, new String[] { "no", "yes" })]
    [TaskPane("Static", "Generate and keep random bytes only once", null, 2, false, DisplayLevel.Beginner, ControlType.ComboBox, new String[] { "no", "yes" })]
    public int KeepRND
    {
