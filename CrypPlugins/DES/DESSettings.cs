...
namespace Cryptool.Plugins.Cryptography.Encryption
{
    public class DESSettings : ISettings
    {
        ...
        [TaskPane("Chaining Mode", "Select the block cipher mode of operation.", null, 2, false, ControlType.ComboBox, new String[] { "Electronic Bode Book (ECB)","Cipher Block Chaining (CBC)","Cipher Feedback (CFB)" })]
        public int Mode
        {
