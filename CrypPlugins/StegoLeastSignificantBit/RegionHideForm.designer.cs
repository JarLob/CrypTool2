namespace Cryptool.Plugins.StegoLeastSignificantBit
{
    partial class RegionHideForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ctlRegions = new RegionInfoList();
			...
			this.label2.Text = "Bitmap and regions - Click to draw a region";
			// 
			// label1
			// 
			...
			this.ctlRegions.SelectionChanged += new RegionInfoList.RegionEventHandler(this.ctlRegions_SelectionChanged);
			this.ctlRegions.Delete += new RegionInfoList.RegionEventHandler(this.ctlRegions_Delete);
			// 
			// btnCancel
			// 
