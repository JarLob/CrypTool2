...
namespace Cryptool.Plugins.BooleanOperators
{
    ...
    [PluginInfo("BooleanOperators.Properties.Resources", true, "PluginInputCaption", "PluginInputTooltip", "PluginDescriptionURL", "BooleanOperators/icons/false.png", "BooleanOperators/icons/true.png")]
    ...
    public class BooleanInput : IInput
    {
        ...
        [PropertyInfo(Direction.OutputData, "BooleanInputOutputCaption", "BooleanInputOutputTooltip", "", false, false, QuickWatchFormat.None, null)]
