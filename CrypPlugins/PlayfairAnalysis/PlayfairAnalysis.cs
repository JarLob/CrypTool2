...
{   
    ...
    [PluginInfo(false, "Playfair Analysis", "Ciphertext only attack on Playfair", "PlayfairAnalysis/DetailedDescription/Description.xaml", "PlayfairAnalysis/Images/icon.png")]
    ...
    public class PlayfairAnalysis : ISpecific
    {
        ...
        /// </summary>
        [PropertyInfo(Direction.InputData, "Text input", "Input a string to be analyzed", null, DisplayLevel.Beginner)]
        ...
        /// </summary>
        [PropertyInfo(Direction.OutputData, "Text output", "The output string after playfair analysis", null, DisplayLevel.Beginner)]
        ...
        [PropertyInfo(Direction.OutputData, "CryptoolStream output", "The raw CryptoolStream data after playfair analysis", null, DisplayLevel.Beginner)]
        ...
        public void Execute()
        {
            ...
            {
                System.Windows.MessageBox.Show("Heap size hast to be a positiv integer!\nHeap size is set to 5000");
            ...
            KeySearcher keySearcher = new KeySearcher(matrixSize, settings.HeapSize, BigraphStat, InputString);
