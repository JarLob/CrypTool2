...
namespace Cryptool.Vernam
{
    ...
    [PluginInfo(false, "Vernam", "Vernam -- substitution cipher / stream cipher which is build by XORing the plaintext with a (pseudo) random stream of data to generate the ciphertext", null, "Vernam/icon.png", "Vernam/Images/encrypt.png", "Vernam/Images/decrypt.png")]
