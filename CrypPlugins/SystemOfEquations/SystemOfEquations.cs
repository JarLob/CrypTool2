...
namespace Cryptool.SystemOfEquations
{
 ...
 "SystemOfEquations/Images/soe.png")]
    public class SystemOfEquations : IAnalysisMisc
    {
        ...
        [PropertyInfo(Direction.InputData, "Z-functions ", "Z-functions as  Hashtable(Z ,FZ) delivred from plugin compute annihilators", "", true, false, DisplayLevel.Beginner, QuickWatchFormat.Text, null)]
        ...
        [PropertyInfo(Direction.OutputData, "System of equation function", " the variables are die Keys Bits (k1,k2..kn)=initial statue of LFSRs", "", false, false, DisplayLevel.Beginner, QuickWatchFormat.Text, null)]
