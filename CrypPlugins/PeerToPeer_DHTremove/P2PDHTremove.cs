...
namespace Cryptool.Plugins.PeerToPeer
{
    ...
    public class P2P_DHTremove : IInput
    {
        ...
        public P2P_DHTremove()
        {
            this.settings = new P2PDHTremoveSettings(this);
        }

        public ISettings Settings
        {
            set { this.settings = (P2PDHTremoveSettings)value; }
        ...
        public void Execute()
        {
            ...
            {
                GuiLogMessage("No key in input. Removing isn't possible.", NotificationLevel.Error);
            }
        }
