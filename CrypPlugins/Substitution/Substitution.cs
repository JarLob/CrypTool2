...
namespace Cryptool.Substitution
{
    ...
    [PluginInfo(false, "Substitution", "Substitution -- classic character-based mono-alphabetic substitution", "Substitution/DetailedDescription/Description.xaml", "Substitution/icon.png")]
