...
namespace Cryptool.ADFGVX
{
    public class ADFGVXSettings : ISettings
    {
        ...
        [TaskPane("Substitution matrix","The matrixed used for encryption/decryption",null,2,false,DisplayLevel.Beginner,ControlType.TextBox,"")]
        ...
        [TaskPane("Standard Matrix","Create default matrix",null,3,false,DisplayLevel.Beginner,ControlType.Button,"")]
        ...
        [TaskPane("Random Matrix","Create random matrix",null,4,false,DisplayLevel.Beginner,ControlType.Button,"")]
        ...
        [TaskPane("Substitution password","Enter the string of the substitution matrix",null,5,false,DisplayLevel.Expert,ControlType.TextBox,"")]
        ...
        [TaskPane("Transpositon password","Transposition password can contain any string of characters. Redundant or invalid characters will be removed before de- or encryption.",
            null,6,false,DisplayLevel.Beginner,ControlType.TextBox,"")]
        ...
        [TaskPane("Clean transposition password","Transposition password, with removed non alphabet character und duplicates",null,7,false,DisplayLevel.Beginner,ControlType.TextBoxReadOnly,"")]
        ...
        [ContextMenu("Unknown symbol handling", "What should be done with encountered characters at the input which are not in the alphabet?", 8, DisplayLevel.Expert, ContextMenuControlType.ComboBox, null, new string[] { "Remove (remove non alphabet characters)", "Replace (e.g. Ü=UE)" })]
        [TaskPane("Unknown symbol handling", "What should be done with encountered characters at the input which are not in the alphabet?", null, 8, false, DisplayLevel.Expert, ControlType.ComboBox, new string[] { "Remove (remove non alphabet characters)", "Replace (e.g. Ü=UE)" })]
        ...
        [ContextMenu("Alphabet case", "Transform the alphabet and input data to upper or lower case", 9, DisplayLevel.Expert, ContextMenuControlType.ComboBox, null, new string[] { "Upper case", "Lower case" })]
        [TaskPane("Alphabet case", "Transfer the alphabet and input data to upper or lower case", null, 9, false, DisplayLevel.Expert, ControlType.ComboBox, new string[] { "Upper case", "Lower case" })]
