...
namespace Cryptool.Plugins.Zufallsgeneratoren
{
    ...
    [PluginInfo("RandomNumberGenerators", "Generators for (pseudo) random numbers", "Zufallsgeneratoren/userdoc.xml", new[] { "Zufallsgeneratoren/Images/Random.png" })]
    ...
    public class Zufallsgeneratoren : ICrypComponent
    {
        ...
        [PropertyInfo(Direction.InputData, "Amount of Numbers", "Declares how many numbers you want to generate")]
        ...
        [PropertyInfo(Direction.OutputData, "OutputStream from the RandomNumberGenerator", "The raw ByteStream generated by the selected RandomNumberGenerator ", false)]
        ...
        [PropertyInfo(Direction.OutputData, "OutputStream as numbers", "The numberArray generated by the selected RandomNumberGenerator", false)]
