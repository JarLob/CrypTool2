...
namespace Keccak.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The state of the sponge construction is initialized. Each of the b bits of the state is initialized to 0. The state is partitioned into two parts: Capacity (c bits) and Bit Rate (r bits). With the current settings the values are: b = {0}, c = {1} and r = {2}..
        /// </summary>
