...
namespace Cryptool.Plugins.DifferentialCryptanalysis
{
    [Author("Christian Bender", "christian1.bender@student.uni-siegen.de", null, "http://www.uni-siegen.de")]
    [PluginInfo("DifferentialCryptanalysis.Properties.Resources", "PluginCaption", "PluginTooltip", "DifferentialCryptanalysis/userdoc.xml", new[] { "DifferentialCryptanalysis/Images/Icon.png" })]
    [ComponentCategory(ComponentCategory.CryptanalysisSpecific)]
    public class DifferentialCryptanalysis : ICrypComponent
    {
        #region Private Variables
        private readonly DifferentialCryptanalysisSettings settings = new DifferentialCryptanalysisSettings();
