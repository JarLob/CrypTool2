...
namespace Cryptool.Caesar
{
    public class CaesarSettings : ISettings
    {
        ...
        [PropertySaveOrder(5)]
        [TaskPane("Key as integer", "Enter the number of letters to shift. For example, a value of 1 means that the plaintext character 'a' gets mapped to the ciphertext character 'B', 'b' to 'C', and so on.", null, 2, true, ControlType.NumericUpDown, ValidationType.RangeInteger, 0, 100)]
