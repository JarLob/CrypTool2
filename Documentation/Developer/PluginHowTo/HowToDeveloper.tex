...
\fancyfoot[C]{\thepage\AddToShipoutPicture*{\BackgroundFooterPic}} %zentrierte Fuﬂzeile
...
%\AddToShipoutPicture{%
    ...
    \put(\strip@pt\@tempdimb,\strip@pt\@tempdimc){
        \includegraphics[width=\headbgwidth, height=\headheight]{figures/ct2Header.png}%
    }
}
...
%\AddToShipoutPicture{%
    ...
    \setlength{\unitlength}{1pt}%
    \put(\strip@pt\@tempdimb,\strip@pt\@tempdimc){
        \includegraphics[width=\headbgwidth, height=0.7cm]{figures/ct2Footer.png}%
    }
}
...
\newcommand\WaterMarkPic{%
    ...
    \setlength{\unitlength}{1pt}%
    \put(\strip@pt\@tempdimb,\strip@pt\@tempdimc){
            \includegraphics[width=0.7\textwidth]{figures/ct_logo}%
    }
}
\makeatother
...
\begin{document}
    ...
    \begin{abstract}
    \textbf{Abstract.} This document is intended for plugin developers.
    \end{abstract}
