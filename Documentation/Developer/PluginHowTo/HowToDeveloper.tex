...
\begin{document}
	...
	\begin{abstract}
     CrypTool 2 is the modern successor of the well-known e-learning platform for cryptography and cryptanalysis \htmladdnormallink{CrypTool 1}{http://www.cryptool.org}, which is used world-wide for educational purposes at schools and universities and in companies and agencies.
...
\begin{itemize}
	\item .NET (a modern software framework with solutions to common programming problems from Microsoft),
	\item C\# (a modern object-oriented programming language, comparable to Java), and
    \item WPF (a modern purely vector-based graphical subsystem for rendering user interfaces in Windows-based applications), plus
    \item Visual Studio 2008 (a development environment) and
