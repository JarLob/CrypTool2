...
namespace Cryptool.PluginBase
{
    ...
    public class ControllerPropertyAttribute : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControllerPropertyAttribute"/> class.
        /// </summary>
        /// <param name="direction">The direction.</param>
        /// <param name="caption">The caption.</param>
        /// <param name="toolTip">The tool tip.</param>
        /// <param name="displayLevel">The display level.</param>
        public ControllerPropertyAttribute(Direction direction, string caption, string toolTip, DisplayLevel displayLevel)
        {
