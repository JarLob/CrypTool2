...
namespace Cryptool.PluginBase.Miscellaneous
{
    ...
    [ContentProperty("Key")]
    public class SLocExtension : MarkupExtension
    {
        public string Key { get; set; }

        public SLocExtension(String key)
        {
            Key = key;
        }
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            try
            {
                ...
                var tabAttribute = (SettingsTabAttribute)Attribute.GetCustomAttribute(service.RootObject.GetType(), typeof(SettingsTabAttribute));
                ResourceManager resman = new ResourceManager(tabAttribute.ResourceFile, service.RootObject.GetType().Assembly);
