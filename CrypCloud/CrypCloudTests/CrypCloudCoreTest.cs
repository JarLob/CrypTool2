...
namespace CrypCloudTests
{
    ...
    public class CrypCloudCoreTest
    {
        ...
        public void Login_invokesVoluntLibInitwithGivenCertificates()
        {
            ...
            cryptCloudCore.Login(caCertificate, ownCertificate);

            A.CallTo(() => voluntLib.InitAndStart(caCertificate, ownCertificate)).MustHaveHappened();
        }
        ...
        public void Login_AbortsAndreturnsFalse_allreadyRunning()
        {
            ...
            var returns = cryptCloudCore.Login(caCertificate, ownCertificate);

            Assert.IsFalse(returns);
            A.CallTo(() => voluntLib.InitAndStart(caCertificate, ownCertificate)).MustNotHaveHappened();
        }
